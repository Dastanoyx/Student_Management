...
public class StudentController {
    ...
    public Student create(@RequestBody Student student) {
        return service.create(student.getFirstName(),
                student.getLastName(),
                student.getEmail(),
                student.getAge());
    ...
    @GetMapping("/by-email")
    public Optional<Student> getByEmail(@RequestParam String email) { return service.getByEmail(email); }


    @PutMapping("/{id}")
    public Student update(@PathVariable Long id,
                          @RequestBody Student student) {
        return service.update(id, student.getFirstName(),student.getLastName(), student.getEmail(), student.getAge());
    }
